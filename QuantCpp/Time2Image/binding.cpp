...
PYBIND11_MODULE(_core, m) {
    ...
    m.def("tril_stats", &tril_stats,
          "Compute statistics on lower triangular part of matrix",
          py::arg("mat"),
          py::arg("mat_name"));

    m.def("diagonal_band_stats", &diagonal_band_stats,
          "Compute diagonal band statistics",
          py::arg("mat"),
          py::arg("mat_name"));

    m.def("diag_lag_stats", &diag_lag_stats,
          "Compute diagonal lag statistics",
          py::arg("mat"),
          py::arg("mat_name"));
}